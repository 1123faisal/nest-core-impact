...
export class DashboardService {
  ...
  getProfile() {
    return this.http.get<User>(
      `${environment.apiUri}/api/v1/org-users/profile`
    );
  }
  ...
  updateProfile(name: string, email: string, mobile: string, avatar?: Blob) {
    ...
    return this.http.post<User>(
      `${environment.apiUri}/api/v1/org-users/update-profile`,
      formData
    );
  }
  ...
  changePassword(
    ...
    return this.http.post(
      `${environment.apiUri}/api/v1/org-users/change-password`,
  ...
  updateDashboardSetting(logo?: File, banner?: File) {
    ...
    return this.http.patch<Setting>(
      `${environment.apiUri}/api/v1/org-users/update-db-settings`,
      form
    );
  }
  ...
  getDashboardSetting() {
    return this.http.get<Setting>(
      `${environment.apiUri}/api/v1/org-users/db-settings`
    );
  }
